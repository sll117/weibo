package com.example.weiboClient;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private List<Comment> fetchComments() {
        String urlStr = "http://10.0.2.2/weiboServer/fetchComments.php";
    ...
    private boolean delete() {
        String urlStr = "http://10.0.2.2/weiboServer/delete.php";
    ...
    private boolean sendComment(String comment) {
        String urlStr = "http://10.0.2.2/weiboServer/send_comment.php";
